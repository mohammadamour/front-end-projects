// the array of words that contains animals names in english
const arrayWords = [
  "leopard",
  "tiger",
  "monkey",
...
// the of words that contains animals names in arabic, in case i
...
// in order to use it to change it into the names of the animals in the next step
